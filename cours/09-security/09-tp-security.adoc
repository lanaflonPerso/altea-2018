...
Pouv ce faire, vous pouvez directement ajouter l'authentification au niveau de la collection :
...
[source,java,linenums]
.com.miage.altea.tp.pokemon_ui.config.RestConfigurationTest.java
----
...
[source,java,linenums]
.com.miage.altea.tp.pokemon_ui.controller.SecurityControllerAdviceTest.java
----
